        ...
        <section className="py-32 md:py-40 bg-background">
            <div className="container mx-auto px-6 md:px-16 max-w-7xl">
                <div className="mb-20 max-w-2xl animate-pulse">
                    <div className="h-16 bg-gray-200 rounded w-64 mb-6"></div>
                    <div className="h-6 bg-gray-200 rounded w-full mb-2"></div>
        ...
        <section className="py-32 md:py-40 bg-background">
            <div className="container mx-auto px-6 md:px-16 max-w-5xl">
                <div className="text-center mb-16 animate-pulse">
                    <div className="h-20 bg-gray-200 rounded w-3/4 mx-auto mb-6"></div>
                    <div className="h-6 bg-gray-200 rounded w-full max-w-2xl mx-auto mb-2"></div>
                    <div className="h-6 bg-gray-200 rounded w-3/4 max-w-2xl mx-auto"></div>
                </div>
